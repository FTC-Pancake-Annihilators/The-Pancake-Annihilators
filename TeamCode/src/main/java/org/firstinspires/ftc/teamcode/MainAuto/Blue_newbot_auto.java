...
public class Blue_newbot_auto extends LinearOpMode {
    ...
    private final int TAG_ID_BLUE = 20;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        path1 = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(63.378, 8.401),
                                new Pose(67.652, 79.885),
        ...
        while (opModeIsActive() && foundTag == null) {
            ...
            for (AprilTagDetection d : detections) if (d.id == TAG_ID_BLUE) { foundTag = d; break; }
            telemetry.addLine("Scanning for Tag 20...");
            telemetry.update();
        }
        ...
        path2 = follower
                ...
                .addPath(
                        new BezierLine(
                                new Pose(95.803, 95.951),
                                new Pose(95.951, 73.105)
                        )
                )
